...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTCONNECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTCONNECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTCONNECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTCONNECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTCONNECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTCONNECT actions', async () => {
      const expectedActions = [
        {
