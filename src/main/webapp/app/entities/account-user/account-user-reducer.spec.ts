...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
