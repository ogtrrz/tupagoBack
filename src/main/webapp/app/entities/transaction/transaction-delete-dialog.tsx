...
export const TransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tupagoBackApp.transaction.delete.question">
        <Translate contentKey="tupagoBackApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
